...
class ScreenEnterMatch(LcarsScreen):
    ...
    def setup(self, all_sprites):
        ...
        self.selectedPlayers = [
            LcarsText(colours.BLACK, (768 - 484 - 32 + 4, 216 + 4),
                      capwords(prefill['0']), 20 / 19),
            LcarsText(colours.BLACK, (768 - 412 - 32 + 4, 216 + 4),
                      capwords(prefill['1']), 20 / 19),
            LcarsText(colours.BLACK, (768 - 484 - 32 + 4, 600 + 4),
                      capwords(prefill['2']), 20 / 19),
            LcarsText(colours.BLACK, (768 - 412 - 32 + 4, 600 + 4),
                      capwords(prefill['3']), 20 / 19)
        ]
        prefill.close()
